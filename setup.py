...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-aeat_non_reusable_plastic_containers',
    download_url='https://github.com:nantic/trytond-aeat_non_reusable_plastic_containers.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-aeat_non_reusable_plastic_containers.git'
    },
    classifiers=[
